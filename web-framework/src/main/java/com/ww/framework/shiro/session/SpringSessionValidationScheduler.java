...
import com.ww.system.utils.ThreadUtils;
...
public class SpringSessionValidationScheduler implements SessionValidationScheduler {
  ...
  private long sessionValidationInterval = 10;
   ...
   * ValidatingSessionManager#validateSessions() ValidatingSessionManager#validateSessions()}
   * method.
   *
   * <p>Unless this method is called, the default value is {@link
  ...
  public void enableSessionValidation() {
    ...
    try {
      executorService.scheduleAtFixedRate(
          ...
          1000,
          sessionValidationInterval * 60 * 1000,

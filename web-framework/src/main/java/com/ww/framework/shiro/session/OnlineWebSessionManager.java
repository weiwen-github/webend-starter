...
import com.ww.system.utils.ShiroConstants;
...
public class OnlineWebSessionManager extends DefaultWebSessionManager {
  ...
  @Autowired ISysUserOnlineService sysUserOnlineService;
  ...
  public void validateSessions() {
    ...
    ISysUserOnlineService userOnlineService =
        SpringContextUtils.getBean(ISysUserOnlineService.class);
    ...
    if (needOfflineIdList.size() > 0) {
      try {
        userOnlineService.deleteBatchOnline(needOfflineIdList);
      } catch (Exception e) {
